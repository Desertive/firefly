...

    {
        describe("Frame merger", () -> {
            ...
            it("should merge two frame lists into one", () -> {
                ...
                assertTrue(frames.get(0).getLeds().get(0).equals(new Color(3,3,3)));
                assertTrue(frames.get(0).getLeds().get(1).equals(new Color(2,2,2)));
                assertTrue(frames.get(1).getLeds().get(0).equals(new Color(3,3,3)));
                assertTrue(frames.get(1).getLeds().get(1).equals(new Color(2,2,2)));
        ...
        describe("Step converter", () -> {
            ...
            it("should create frames from transition steps", () -> {
                ...
                assertTrue(frames.get(0).getLeds().get(0).equals(new Color(6,6,6)));
                assertTrue(frames.get(1).getLeds().get(0).equals(new Color(4,3,4)));
                assertTrue(frames.get(2).getLeds().get(0).equals(new Color(2,0,2)));
                assertTrue(frames.get(3).getLeds().get(0).equals(new Color(3,2,3)));
                assertTrue(frames.get(4).getLeds().get(0).equals(new Color(4,4,4)));
                assertTrue(frames.get(5).getLeds().get(0).equals(new Color(5,6,5)));
                assertTrue(frames.get(6).getLeds().get(0).equals(new Color(6,8,6)));
                assertTrue(frames.get(7).getLeds().get(0).equals(new Color(100,50,100)));
                assertTrue(frames.get(8).getLeds().get(0).equals(new Color(53,28,53)));
