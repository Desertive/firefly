...
public interface SocketIOServer {
     ...
     *
     * @param eventName Enum value of the event name
     * @param dataType  Request data model
     * @param lambda    Callback function for the event
     */
     ...
     * @param eventName Enum value of the event name
     * @param dataType  Request data model
     * @param lambda    Callback function for the event. Request object will be passed as
     *                  a parameter
     */
